...
protocol ScheduleOptionDelegate : class {
...
class ScheduleOptionTableViewController: UITableViewController {
    ...
    let scheduleOptions = ScheduleOption.allTypes
    var selectedScheduleOption = ScheduleOption.now
    weak var scheduleOptionDelegate : ScheduleOptionDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.selectedScheduleOption = scheduleOptions[indexPath.row]
        scheduleOptionDelegate?.scheduleOptionSelected(selectedScheduleOption: selectedScheduleOption)
